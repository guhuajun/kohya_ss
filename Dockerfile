FROM 192.168.0.96:5000/greggu/cf2024-toolbox:notebook

ENV VIRTUAL_ENV /env
ENV PATH /env/bin:$PATH

# RUN pip install xformers==0.0.23.post1 ninja

RUN --mount=source=requirements_linux_docker.txt,target=requirements_linux_docker.txt \
